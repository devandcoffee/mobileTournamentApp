...
export default {
  ...
  // Segment
  segmentBackgroundColor: '#00796B',
  segmentActiveBackgroundColor: '#fff',
  segmentTextColor: '#fff',
  segmentActiveTextColor: '#00796B',
  segmentBorderColor: '#fff',
  segmentBorderColorMain: '#00796B',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: '#00796B',

  // FooterTab
  tabBarTextColor: this.secondaryTextColor,
